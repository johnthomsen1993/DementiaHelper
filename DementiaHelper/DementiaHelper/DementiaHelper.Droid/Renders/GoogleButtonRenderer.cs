...
[assembly: ExportRenderer(typeof(GoogleButtonCustomRender), typeof(GoogleButtonRenderer))]
namespace DementiaHelper.Droid.Renders
{
    class GoogleButtonRenderer : ButtonRenderer
    {
        ...
        protected override void OnElementChanged(ElementChangedEventArgs<Xamarin.Forms.Button> e)
        {
            ...
            if (Control != null)
            {
                ...
                if (button.BackgroundColor.R == -1.0 && button.BackgroundColor.G == -1.0 && button.BackgroundColor.B == -1.0)
                    _normal.SetColor(Android.Graphics.Color.ParseColor("#d62d20"));
                else
